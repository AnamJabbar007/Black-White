...
useGSAP(() => {
  ...
  return (
    <div id="section2"  className="bg-white text-center overflow-x-hidden p-6 xl:p-10 text-black">
       <h3 className="text-gray-500 text-xl font-[Anzo3]">
       ©  anzo.studio 2024 | designed and developed</h3>
       <div  className="rotateText mt-40">
        <h1 className="text-[42vw] font-[Anzo2] text-black uppercase leading-[35vw]">IMPACTFUL</h1>
       </div>
       <div className="rotateText">
        <h1 className="text-[42vw] font-[Anzo2] text-black uppercase leading-[35vw]">design</h1>
       </div>
       <div className="rotateText">
        <h1 className="text-[42vw] font-[Anzo2] text-black uppercase leading-[35vw]">is the</h1>
       </div>
       <div className="rotateText">
        <h1 className="text-[42vw] font-[Anzo2] text-black uppercase leading-[35vw]">design</h1>
       </div>
       <div className="rotateText">
        <h1 className="text-[42vw] font-[Anzo2] text-black uppercase leading-[35vw]">that</h1>
       </div>
       <div className="rotateText">
        <h1 className="text-[42vw] font-[Anzo2] text-black uppercase leading-[35vw]">Works</h1>
       </div>
       <div className="flex items-center justify-center xl:scale-75 scale-50">
...
<div className="xl:h-1 h-[2px] w-1/3 relative left-1/2 -translate-x-1/2 xl:mt-40 mt-10 bg-black"></div>
    </div>
  )
}
