      ...
      <div className="sm:h-screen sm:p-2 w-full relative p-5 overflow-hidden h-auto bg-black rounded-[30px]  ">
        ...
        <div className="flex justify-between relative bottom-5 sm:top-14 pt-0 sm:mx-2 mx-10 w-10/12 left-1/2 transform -translate-x-[60%]  items-center ">
          <div className="flex gap-5 sm:gap-1">
            <img
              ref={sun}
              className="w-[4vw] mt-4 h-[4vw]"
              src="https://static.wixstatic.com/media/f1c650_67833facdc7a47d5aae7870d4fb7fc3e~mv2.png/v1/fill/w_86,h_86,al_c,q_85,usm_0.66_1.00_0.01,enc_auto/SUN.png"
              alt=""
            />
          ...
          <div className="flex gap-5 sm:gap-1">
            <img
              ref={devcircle}
              className="w-[4vw] mt-4 h-[4vw]"
              src="https://static.wixstatic.com/media/f1c650_027515148725478cbb3a91eca452cabf~mv2.png/v1/fill/w_81,h_81,al_c,q_85,usm_0.66_1.00_0.01,enc_auto/EARTH.png"
              alt=""
            />
            <h4 className="text-[5vw] font-[Anzo2] text-white uppercase">
          ...
          <div className="flex -ml-6 gap-5 sm:gap-1">
            <img
              ref={rocket}
              className="w-[4.25vw]  mt-4 h-[4.25vw]"
              src="https://static.wixstatic.com/media/f1c650_b0000fd9a706421aa0ea84da62ae3354~mv2.png/v1/fill/w_83,h_83,al_c,q_85,usm_0.66_1.00_0.01,enc_auto/START%20UP.png"
              alt=""
            />
            <h4 className="text-[5vw] font-[Anzo2] text-white uppercase">
        ...
        <div className="relative sm:top-80">
          <div className=" relative  bottom-0 leading-5 sm:leading-3 left-10">
            ...
            <div
              id="ArrowCircle"
              className="w-10 sm:w-6 h-10 sm:h-6 rotate-45 flex justify-start text-center p-2 sm:p-1 items-center  rounded-full absolute right-20 bottom-0 bg-white"
            >
              {" "}
