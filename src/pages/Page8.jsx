    ...
    <div className="h-auto w-full sm:w-auto relative bg-white sm:p-2 p-5">
      <div className=" w-full sm:p-2 sm:w-auto relative p-10 overflow-hidden h-auto bg-black rounded-[30px]">
          ...
          <div className="w-[40%] relative">
            <div className="flex flex-col gap-[2px]">
              ...
              <div className="flex ">
                ...
                <span className="w-10 h-10 sm:w-6 sm:h-6 sm:p-1 mt-32 sm:mt-6 -rotate-[132deg] flex justify-start text-center p-2 items-center  rounded-full   bg-white">
            ...
            <img
              ref={clock}
              className="absolute top-[40%] w-[60vh] h-auto"
              src={circle}
              alt=""
            />
          </div>
        ...
        <div className=" relative  bottom-0 leading-5 sm:leading-3 left-">
          ...
          <div
            id="ArrowCircle"
            className="w-10 h-10 sm:w-6 sm:h-6 sm:p-1 rotate-45 flex justify-start text-center p-2 items-center  rounded-full absolute sm:right-4 right-20 bottom-0 bg-white"
          >
            {" "}
            <IoArrowDown className="text-4xl text-black" />
          </div>
